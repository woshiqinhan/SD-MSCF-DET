...
class SD_PSA(C2PSA):
    ...
    Examples:
        >>> sd_psa = SD_PSA(c1=256, c2=256, n=3, e=0.5)
        >>> input_tensor = torch.randn(1, 256, 64, 64)
        >>> output_tensor = sd_psa(input_tensor)
    """
    def __init__(self, c1, c2, n=1, e=0.5):
        super().__init__(c1, c2, n, e)
...
class PSABlock_EDFFN(PSABlock):
    ...
    def __init__(self, c, attn_ratio=0.5, num_heads=4, shortcut=True):
        super().__init__(c, attn_ratio, num_heads, shortcut)
        # 替换FFN为EDFFN
        self.ffn = EDFFN(dim=c, mlp_ratio=2.66, patch_size=2)
...
class SD_PSA_Mona(C2PSA):
    ...
    Examples:
        >>> sd_psa_mona = SD_PSA_Mona(c1=256, c2=256, n=3, e=0.5)
        >>> input_tensor = torch.randn(1, 256, 64, 64)
        >>> output_tensor = sd_psa_mona(input_tensor)
    """
    def __init__(self, c1, c2, n=1, e=0.5):
        super().__init__(c1, c2, n, e)
...
class SD_PSABlock_Mona_SEFN(PSABlock):
    ...
    def __init__(self, c, attn_ratio=0.5, num_heads=4, shortcut=True):
        ...
        # 空间增强FFN
        self.ffn = SEFN(dim=c, ffn_expansion_factor=2.66)
...
class SD_PSA_Mona_SEFN(C2PSA):
    ...
    Examples:
        >>> sd_psa_mona_sefn = SD_PSA_Mona_SEFN(c1=256, c2=256, n=3, e=0.5)
        >>> input_tensor = torch.randn(1, 256, 64, 64)
        >>> output_tensor = sd_psa_mona_sefn(input_tensor)
    """
    def __init__(self, c1, c2, n=1, e=0.5):
        super().__init__(c1, c2, n, e)
...
class SD_PSABlock_Mona_SEFFN(PSABlock):
    ...
    def __init__(self, c, attn_ratio=0.5, num_heads=4, shortcut=True):
        ...
        # 频谱增强FFN
        # self.ffn = SpectralEnhancedFFN(dim=c, expansion_factor=2.66, drop=0.0)
        self.ffn = SpectralEnhancedFFN(dim=c, ffn_expansion_factor=2.66)
        # 动态Tanh归一化
        self.dyt1 = DynamicTanh(normalized_shape=c, channels_last=False)
        self.dyt2 = DynamicTanh(normalized_shape=c, channels_last=False)
...
class SD_PSA_Mona_SEFFN(C2PSA):
    ...
    Examples:
        >>> sd_psa_mona_seffn = SD_PSA_Mona_SEFFN(c1=256, c2=256, n=3, e=0.5)
        >>> input_tensor = torch.randn(1, 256, 64, 64)
        >>> output_tensor = sd_psa_mona_seffn(input_tensor)
    """
    def __init__(self, c1, c2, n=1, e=0.5):
        super().__init__(c1, c2, n, e)
...
class SD_PSA_Mona_EDFFN(C2PSA):
    ...
    Examples:
        >>> sd_psa_mona_edffn = SD_PSA_Mona_EDFFN(c1=256, c2=256, n=3, e=0.5)
        >>> input_tensor = torch.randn(1, 256, 64, 64)
        >>> output_tensor = sd_psa_mona_edffn(input_tensor)
    """
    def __init__(self, c1, c2, n=1, e=0.5):
        super().__init__(c1, c2, n, e)
